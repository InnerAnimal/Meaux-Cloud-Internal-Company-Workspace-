...
# Script to add Connor (Engineer) as a collaborator to GitHub repos
# Usage: ./add-collaborator.sh [username]
# Default repo: Meaux-Cloud-Internal-Company-Workspace-
# Default username: connordmcneely96

REPO_NAME="Meaux-Cloud-Internal-Company-Workspace-"
USERNAME="${1:-connordmcneely96}"
